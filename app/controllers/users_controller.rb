...
private
  def user_params
    params.require(:user).permit(:password, :first_name, :last_name, :role, :picture, :gender, :location, :bio, :email, :birthday, :education_level, :linkedin_url, :provider, :uid, :employment_status, industries_attributes: [:name], :industry_ids => [])
  end
